...
const LogisticsDashboard: React.FC = () => {
  ...
  const monthOptions = getLast3Months()
    ...
    <>
      ...
      <PageWrapper title="Dashboard" description="Warehouse Management System Overview">
        ...
        <div className="max-w-7xl mx-auto">
          {/* Header */}
          {/* <div className="mb-4">
          <h1 className="text-2xl font-bold text-blue-800 mb-0">Activity Dashboard</h1>
          <p className="text-slate-400">Monitor transaksi inbound dan outbound</p>
        </div> */}
