...
export default function Dashboard() {
  ...
  useEffect(() => {
    document.title = "Inventory - WMS Activity";
  }, []);
  ...
  return (
    <>
      <TopNav />
      <PageWrapper title="Inventory" description="Warehouse Management System Overview">

        {/* Header */}
        <div className="mb-3">
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">Inventory</h1>
